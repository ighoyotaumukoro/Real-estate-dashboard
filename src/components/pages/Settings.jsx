          ...
          <main className="page-body">
            <div className="page-header">
              <div>
                ...
                <p className="text-nowrap text-start fw-semibold">
              ...
              <div className="header-actions">
                <button className="btn-primary">
                  ...
                  >
                    <path
                      d="M11.4 2.25C11.7957 2.25564 12.1731 2.41738 12.45 2.7L15.3 5.55C15.5826 5.82695 15.7444 6.20435 15.75 6.6V14.25C15.75 14.6478 15.592 15.0294 15.3107 15.3107C15.0294 15.592 14.6478 15.75 14.25 15.75H3.75C3.35218 15.75 2.97064 15.592 2.68934 15.3107C2.40804 15.0294 2.25 14.6478 2.25 14.25V3.75C2.25 3.35218 2.40804 2.97064 2.68934 2.68934C2.97064 2.40804 3.35218 2.25 3.75 2.25H11.4Z"
                      stroke="white"
                      stroke-width="1.5"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M12.75 15.75V10.5C12.75 10.3011 12.671 10.1103 12.5303 9.96967C12.3897 9.82902 12.1989 9.75 12 9.75H6C5.80109 9.75 5.61032 9.82902 5.46967 9.96967C5.32902 10.1103 5.25 10.3011 5.25 10.5V15.75"
                      stroke="white"
                      stroke-width="1.5"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M5.25 2.25V5.25C5.25 5.44891 5.32902 5.63968 5.46967 5.78033C5.61032 5.92098 5.80109 6 6 6H11.25"
                      stroke="white"
                      stroke-width="1.5"
                      stroke-linecap="round"
                      stroke-linejoin="round"
            ...
            <div className="stat-card">
              <div className="col-12">
                <div
                  className="row text-start fw-semibold"
                  style={{ fontSize: "16px" }}
                >
                  <div className="col-lg-6">
                    <p className="h5 fw-bold">General Information</p>
                    <p className="pt-4 mb-0 text-muted ">COMPANY NAME</p>
                    <input
                      type="text"
                      className="w-100 search-input rounded-3"
                      placeholder="John Doe Limited"
                    />
                    <p className="pt-4 mb-0 text-muted">PRIMARY EMAIL</p>
                    <input
                      type="email"
                      className="w-100 search-input rounded-3"
                      placeholder="johndoeltd@gmail.com"
                    />
                    <p className="pt-4 mb-0 text-muted">PHONE NUMBER</p>
                    <input
                      type="number"
                      className="w-100 search-input rounded-3"
                  ...
                  <div className="col-lg-6 mx-auto">
                    <p className="fw-bold">Branding</p>
                    <div className="row">
                      <p className="col-2 justify-content-center align-self-center py-4 fw-semibold bg-light shadow-sm text-center text-primary ms-3">
                        B
                      </p>
                      <p className="col-4 fw-bold text-nowrap">
                        Company Logo
                        <p className="mt-1 text-primary fw-lighter text-nowrap">
                          <svg
                            className="me-2"
                            width="20"
                            height="20"
              ...
              <div className="col-12">
                <p className="h5 fw-bold text-start">Social Media</p>
                <div
                  className="row text-start fw-semibold"
                  style={{ fontSize: "16px" }}
                >
                  <div className="col-lg-6">
                    <p className="mb-0 text-muted">INSTAGRAM</p>
                    <input
                      type="text "
                      className="w-100 search-input rounded-3 mb-3"
                      placeholder="https//..."
                    />
                    <p className="mb-0 text-muted">X(TWITTER)</p>
                    <input
                      type="text"
                      className="w-100 search-input rounded-3"
                      placeholder="https//..."
                  ...
                  <div className="col-lg-6">
                    <p className="mb-0 text-muted">FACEBOOK</p>
                    <input
                      type="text"
                      className="w-100 search-input rounded-3 mb-3"
                      placeholder="https//..."
                    />
                    <p className="mb-0 text-muted">LINKEDIN</p>
                    <input
                      type="text"
                      className="w-100 search-input rounded-3"
                      placeholder="https//..."
